...
```sh
npm install git+ssh://git@github.com:kennyjwilli/GNverifier.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/kennyjwilli/GNverifier/issues) with questions, bugs, or suggestions.
